...
-- drop table stg.pick_5_20151111;
-- create table stg.pick_5_20151111
-- as
-- select *
-- from (
--  SELECT 
--    player, pos, team, salary, gr, 
--    dense_rank() over (partition by pos ORDER BY pr_ictsh_rank) rn
--  FROM stg.picks_20151111
...
from 
(select player, pos, team, salary, rn from stg.pick_5_20151111 WHERE pos = 'PG' ) PG1,
(select player, pos, team, salary, rn from stg.pick_5_20151111 WHERE pos = 'PG' ) PG2,
(select player, pos, team, salary, rn from stg.pick_5_20151111 WHERE pos = 'SG' and gr != 24) SG1,
(select player, pos, team, salary, rn from stg.pick_5_20151111 WHERE pos = 'SG' and gr != 24) SG2,
(select player, pos, team, salary, rn from stg.pick_5_20151111 WHERE pos = 'SF' ) SF1,
(select player, pos, team, salary, rn from stg.pick_5_20151111 WHERE pos = 'SF' ) SF2,
(select player, pos, team, salary, rn from stg.pick_5_20151111 WHERE pos = 'PF' ) PF1,
(select player, pos, team, salary, rn from stg.pick_5_20151111 WHERE pos = 'PF' ) PF2,
(select player, pos, team, salary, rn from stg.pick_5_20151111 WHERE pos = 'C' ) C
WHERE 1=1
...
and pg1.salary + pg2.salary + sg1.salary + sg2.salary + sf1.salary + sf2.salary + pf1.salary + pf2.salary + c.salary >= 59900
